...
import { StatutLogComponent } from './statut-log/statut-log.component';
...
@NgModule({
  ...
  imports: [
    ...
    MatListModule, MatCardModule, MatCheckboxModule, MatSlideToggleModule,FlexLayoutModule,ReactiveFormsModule,MatToolbarModule,
